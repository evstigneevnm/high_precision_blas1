...
public:
                          ...
                          vector_type &x)const
    {
        ...
        while (!monitor_.check_finished(x, *checked_ri))
        {
            ...
            if (detail::isnan(beta)) { logged_obj_t::info("solve: stop iterations because beta is ind"); not_valid_coeff_faced = true; break; }
            if (detail::isinf(beta)) { logged_obj_t::info("solve: stop iterations because beta is inf"); not_valid_coeff_faced = true; break; }
            ...
            if (detail::isnan(alpha)) { logged_obj_t::info("solve: stop iterations because alpha is nan"); not_valid_coeff_faced = true; break; }
            if (detail::isinf(alpha)) { logged_obj_t::info("solve: stop iterations because alpha is inf"); not_valid_coeff_faced = true; break; }
            ...
            if (detail::isnan(omega_i)) { logged_obj_t::info("solve: stop iterations because omega_i is nan"); not_valid_coeff_faced = true; break; }
            if (detail::isinf(omega_i)) { logged_obj_t::info("solve: stop iterations because omega_i is inf"); not_valid_coeff_faced = true; break; }
